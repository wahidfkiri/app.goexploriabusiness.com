                                    ...
                                    <li class="dropdown mega-menu-item"><a href="#">Destinations</a>
                                        <ul class="dropdown-menu">
                                            <li class="mega-menu-content">
                                                <div class="row">
                                                    @foreach(\App\Models\Province::where('country_id', $countrie->id)->active()->get() as $key)
                                                    <div class="col-lg-3">
                                                         <div class="card">
                                                          <div class="card-body d-flex align-items-center gap-3">
                                                           <a href="{{url('country')}}/{{$key->code}}" class="align-items-center text-decoration-none d-grid" style="text-align:center">
                                                             <img src="{{asset('storage')}}/{{$key->image}}"  class="align-items-center w-100 me-3" style="height: 275px;">
