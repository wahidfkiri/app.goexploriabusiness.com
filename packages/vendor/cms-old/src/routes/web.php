...
Route::get('/company/{etablissementSlug}/robots.txt', [AdminSettingController::class, 'robots']);
Route::get('/company/{etablissementSlug}/sitemap.xml', [AdminSettingController::class, 'sitemap']);
});
...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::prefix('admin/cms/blocks')->name('cms.admin.global-blocks.')->group(function () {
        Route::get('/', [BlockController::class, 'globalIndex'])->name('index');
        Route::get('/manage', [BlockController::class, 'globalList'])->name('manage');
        Route::post('/', [BlockController::class, 'globalStore'])->name('store');
        Route::put('/{id}', [BlockController::class, 'globalUpdate'])->name('update');
        Route::delete('/{id}', [BlockController::class, 'globalDestroy'])->name('destroy');
        Route::get('/{id}/preview', [BlockController::class, 'globalPreview'])->name('preview');
    });
    ...
    Route::prefix('admin/cms/{etablissementId}')->name('cms.admin.')->group(function () {
        ...
        Route::prefix('/blocks')->name('blocks.')->group(function () {
            ...
            Route::get('/manage', [BlockController::class, 'list'])->name('manage');
            ...
            Route::get('/{id}/preview', [BlockController::class, 'preview'])->name('preview');
        });
