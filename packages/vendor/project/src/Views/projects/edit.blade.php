...
<main class="dashboard-content">
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('projects.show', $project) }}" class="btn btn-outline-secondary me-2" data-bs-toggle="tooltip" title="Voir les détails complets du projet">
                <i class="fas fa-eye me-2"></i>Voir le projet
            </a>
            <a href="{{ route('projects.index') }}" class="btn btn-outline-secondary me-2" data-bs-toggle="tooltip" title="Retourner à la liste des projets sans sauvegarder">
                <i class="fas fa-arrow-left me-2"></i>Retour à la liste
            </a>
            <button type="button" class="btn btn-primary" id="updateProjectBtn" data-bs-toggle="tooltip" title="Mettre à jour le projet (Ctrl+S)">
    ...
    <form id="projectForm" method="POST" action="{{ route('projects.update', $project) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-progress-modern">
            <div class="progress-steps">
                ...
                <div class="progress-step" data-step="3" data-bs-toggle="tooltip" title="Étape 3: Dates et budget du projet">
                    <div class="step-number">3</div>
                    <div class="step-label">Planning & Budget</div>
                </div>
                <div class="progress-step" data-step="4" data-bs-toggle="tooltip" title="Étape 4: Configuration avancée et options">
        ...
        <div class="form-step active" id="step1">
            <div class="form-card-modern">
                <div class="form-card-header">
                    ...
                    <p class="form-card-subtitle">Modifiez les informations de base du projet</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   title="Modifiez le nom du projet - il doit rester unique et descriptif">
                            @error('name')
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="status" class="form-label-modern required-field" data-bs-toggle="tooltip" title="État d'avancement actuel du projet">
                                Statut
                                <i class="fas fa-question-circle ms-1 text-muted" style="font-size: 0.9rem;"></i>
                            </label>
...
@endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="form-select-modern select2-modern @error('user_id') is-invalid @enderror" 
                                    ...
                                    required
                                    data-bs-toggle="tooltip"
                                    title="Changez le responsable du projet si nécessaire">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            @enderror
                            <small class="form-text-modern text-muted">
                                Laissez vide si pas de contrat
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control-modern rich-editor @error('description') is-invalid @enderror" 
                                  ...
                                  rows="5"
                                  data-bs-toggle="tooltip"
                                  title="Mettez à jour la description du projet, les objectifs ou le périmètre">{{ old('description', $project->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback-modern">{{ $message }}</div>
                        @enderror
                        <small class="form-text-modern text-muted">
                        ...
                        <div class="tags-container" id="tagsContainer">
                            @if(!empty($tags))
                                @foreach(explode(',', $tags) as $tag)
                                    @if(trim($tag))
                                        <span class="tag-item" data-bs-toggle="tooltip" title="Cliquez sur la croix pour supprimer ce tag">
                                            {{ trim($tag) }}
                                            <span class="remove-tag" data-tag="{{ trim($tag) }}">&times;</span>
                                        </span>
                                    @endif
                                @endforeach
                            @endif
        ...
        <div class="form-step" id="step2">
            <div class="form-card-modern">
                <div class="form-card-header">
                    ...
                    <p class="form-card-subtitle">Modifiez les informations du client et du contact principal</p>
                </div>
                ...
                <div class="form-card-body">
                    <div class="row">
                        <!-- Client -->
                        <div class="col-md-6 mb-4">
                            <label for="client_id" class="form-label-modern" data-bs-toggle="tooltip" title="Sélectionnez un client existant ou laissez vide">
                                Client
                                <i class="fas fa-question-circle ms-1 text-muted" style="font-size: 0.9rem;"></i>
                            </label>
                    ...
                    <!-- Client Info Card -->
                    <div class="client-info-card" id="clientInfoCard" style="{{ $project->client_id ? 'display: block;' : 'display: none;' }}" data-bs-toggle="tooltip" title="Informations détaillées du client sélectionné">
                        ...
                        <div class="client-info-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Ville:</strong> 
                                    <span id="clientVille">{{ $project->client->ville ?? '' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Téléphone:</strong> 
                                    <span id="clientPhone">{{ $project->client->phone ?? '' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Email:</strong> 
                                    <span id="clientEmail">{{ $project->client->email_contact ?? '' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="form-step" id="step3">
            <div class="form-card-modern">
                <div class="form-card-header">
                    ...
                    <p class="form-card-subtitle">Modifiez les dates et estimations financières</p>
                </div>
                ...
                <div class="form-card-body">
                    <div class="row">
                        <!-- Start date -->
                        <div class="col-md-6 mb-4">
                            <label for="start_date" class="form-label-modern" data-bs-toggle="tooltip" title="Date de début du projet">
                                Date de début
                                <i class="fas fa-question-circle ms-1 text-muted" style="font-size: 0.9rem;"></i>
                            </label>
                            <div class="input-group-modern">
                                ...
                                <input type="date" 
                                       ...
                                       data-bs-toggle="tooltip"
                                       title="Modifiez la date de début du projet">
                            </div>
                            @error('start_date')
                                <div class="invalid-feedback-modern">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="date" 
                                       ...
                                       data-bs-toggle="tooltip"
                                       title="Modifiez la date de fin estimée du projet">
                            </div>
                            @error('end_date')
                                <div class="invalid-feedback-modern">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="Ex: 120"
                                       data-bs-toggle="tooltip"
                                       title="Mettez à jour l'estimation en heures homme">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="Ex: 50"
                                       data-bs-toggle="tooltip"
                                       title="Modifiez le prix par heure de travail">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="number" 
                                       ...
                                       placeholder="Ex: 6000"
                                       data-bs-toggle="tooltip"
                                       title="Mettez à jour le budget global estimé">
                    ...
                    <div class="budget-preview" id="budgetPreview" style="display: {{ ($project->estimated_hours || $project->hourly_rate) ? 'block' : 'none' }};" data-bs-toggle="tooltip" title="Calcul automatique basé sur les heures et le taux horaire">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="budget-item">
                                        ...
                                        <span class="budget-value" id="previewHours">{{ $project->estimated_hours ?? 0 }}</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="budget-item">
                                        <span class="budget-label">Taux horaire:</span>
                                        <span class="budget-value" id="previewRate">{{ number_format($project->hourly_rate ?? 0, 2) }} €</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="budget-item total">
                                        <span class="budget-label">Total calculé:</span>
                                        <span class="budget-value" id="previewTotal">{{ number_format(($project->estimated_hours ?? 0) * ($project->hourly_rate ?? 0), 2) }} €</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select class="form-select-modern" id="priority" name="priority" data-bs-toggle="tooltip" title="Modifiez la priorité du projet">
                                <option value="low" {{ ($priority ?? 'medium') == 'low' ? 'selected' : '' }} data-bs-toggle="tooltip" title="Priorité basse - projet standard">Basse</option>
                                <option value="medium" {{ ($priority ?? 'medium') == 'medium' ? 'selected' : '' }} data-bs-toggle="tooltip" title="Priorité moyenne - projet normal">Moyenne</option>
                                <option value="high" {{ ($priority ?? 'medium') == 'high' ? 'selected' : '' }} data-bs-toggle="tooltip" title="Priorité haute - projet important">Haute</option>
                                <option value="urgent" {{ ($priority ?? 'medium') == 'urgent' ? 'selected' : '' }} data-bs-toggle="tooltip" title="Urgent - projet prioritaire">Urgente</option>
                            </select>
                            <small class="form-text-modern text-muted">
                        ...
                        <div class="notification-options">
                            <div class="form-check-modern">
                                <input type="checkbox" class="form-check-input" id="notify_team" name="notify_team" checked
                                       data-bs-toggle="tooltip" title="Envoyer une notification à l'équipe des modifications">
                                <label class="form-check-label" for="notify_team">
                                    <i class="fas fa-users me-2"></i>
                                    Notifier l'équipe des modifications
                                </label>
                            </div>
                            <div class="form-check-modern">
                                <input type="checkbox" class="form-check-input" id="notify_client" name="notify_client"
                                       data-bs-toggle="tooltip" title="Envoyer un email au client pour l'informer des modifications">
                    ...
                    <!-- Fichiers joints -->
                    <div class="mb-4">
                        <label for="attachments" class="form-label-modern" data-bs-toggle="tooltip" title="Ajouter de nouveaux documents au projet">
                        ...
                        <div class="file-upload-modern">
                            ...
                            <div class="file-upload-area" data-bs-toggle="tooltip" title="Cliquez ou glissez-déposez des fichiers">
                                ...
                                <p>Glissez-déposez vos nouveaux fichiers ici ou cliquez pour sélectionner</p>
                    ...
                    <div class="alert alert-info" data-bs-toggle="tooltip" title="Historique des modifications du projet">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Dernière modification :</strong> {{ $project->updated_at->format('d/m/Y à H:i') }}
                        @if($project->metadata)
                            @php $metadata = json_decode($project->metadata, true); @endphp
                            @if(!empty($metadata['updated_by']))
                                par {{ $metadata['updated_by'] }}
                            @endif
                        @endif
                    </div>
                    ...
                    <div class="form-navigation d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success" id="submitBtn" data-bs-toggle="tooltip" title="Enregistrer toutes les modifications du projet">
    ...
    <div class="loading-overlay" id="loadingOverlay" style="display: none;">
        <div class="loading-content">
            ...
            <p class="mt-3">Mise à jour du projet en cours...</p>
        </div>
    </div>
</main>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Actualiser les tooltips lors des changements d'étapes
...
$(document).ready(function() {
    ...
    $('#projectForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    showNotification('success', 'Projet mis à jour avec succès !');
                    localStorage.removeItem('project_draft');
                    localStorage.removeItem('project_draft_time');
                    
                    setTimeout(function() {
                        window.location.href = response.redirect || '{{ route("projects.show", $project) }}';
                    }, 1500);
                } else {
    ...
    function autoSaveDraft() {
        ...
        if (descriptionEditor) {
            const descriptionData = '&description=' + encodeURIComponent(descriptionEditor.getData());
            localStorage.setItem('project_edit_draft', formData + descriptionData);
        } else {
            localStorage.setItem('project_edit_draft', formData);
        }
        
        localStorage.setItem('project_edit_draft_time', new Date().toISOString());
    ...
    function updateCharCount() {
        const content = descriptionEditor ? descriptionEditor.getData() : $('#description').val();
    ...
    if (!$('#description').next('.character-counter').length) {
        $('#description').after(`<div class="character-counter text-muted small mt-1">
    ...
    console.log('Project edit form initialized successfully');
});
</script>
