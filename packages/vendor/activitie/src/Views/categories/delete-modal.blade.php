    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="delete-message">Êtes-vous sûr de vouloir supprimer cette catégorie ?</p>
                
                <div class="category-to-delete" id="categoryToDeleteInfo">
                    <!-- Category info will be loaded here -->
                </div>
                
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-circle me-2"></i>
                    <strong>Attention :</strong> Cette catégorie ne peut pas être supprimée si elle contient des sites web ou des templates.
                </div>
            </div>
