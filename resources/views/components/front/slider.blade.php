    ...
    <section class="carousel-section">
        ...
        <div class="main-carousel">
            ...
            <!-- Slide 1 - Voyage -->
            <div class="carousel-slide active" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1511497584788-876760111969?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')">
            ...
            <!-- Slide 2 - Technologie -->
            <div class="carousel-slide" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1511497584788-876760111969?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')">
                <div class="slide-content d-none">
                    <span class="video-category">Technologie</span>
                    <h3 class="video-title">Les nouvelles tendances en intelligence artificielle</h3>
                    <div class="video-meta">
                        <span><i class="far fa-eye"></i> 1.8M vues</span>
                        <span><i class="far fa-clock"></i> Il y a 1 semaine</span>
                        <span><i class="far fa-thumbs-up"></i> 35K</span>
                    </div>
                    <button class="play-btn" data-video-id="jjqgP9dpD1k">
                        <i class="fas fa-play"></i> Regarder maintenant
                    </button>
                </div>
            </div>
            ...
            <!-- Slide 3 - Cuisine -->
            <div class="carousel-slide" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1542744095-fcf48d80b0fd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')">
                <div class="slide-content d-none">
                    <span class="video-category">Cuisine</span>
                    <h3 class="video-title">Recette facile : Gâteau au chocolat en 15 minutes</h3>
                    <div class="video-meta">
                        <span><i class="far fa-eye"></i> 3.2M vues</span>
                        <span><i class="far fa-clock"></i> Il y a 2 jours</span>
                        <span><i class="far fa-thumbs-up"></i> 58K</span>
                    </div>
                    <button class="play-btn" data-video-id="Fq2SbrWnfFI">
                        <i class="fas fa-play"></i> Regarder maintenant
                    </button>
                </div>
            </div>
           ...
           <?php foreach(\App\Models\CountryMedia::all() as $item){ ?>
            {
                ...
                title: "Islande - Voyage",
                category: "Voyage",
                views: "2.5M vues",
                time: "Il y a 3 jours",
                likes: "42K",
                image: "https://images.unsplash.com/photo-1536240478700-b869070f9279?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
                mainImage: "https://images.unsplash.com/photo-1536240478700-b869070f9279?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
                description: "Découvrez les plus beaux paysages islandais"
            },
            <?php } ?>
            {
                id: 1,
                ...
                likes: "35K",
                image: "https://images.unsplash.com/photo-1511497584788-876760111969?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
                mainImage: "https://images.unsplash.com/photo-1511497584788-876760111969?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
                description: "Les nouvelles tendances en intelligence artificielle"
            },
            {
                id: 2,
                videoId: "Fq2SbrWnfFI",
                ...
                time: "Il y a 2 jours",
                likes: "58K",
                image: "https://images.unsplash.com/photo-1542744095-fcf48d80b0fd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
                mainImage: "https://images.unsplash.com/photo-1542744095-fcf48d80b0fd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
                description: "Recette facile : Gâteau au chocolat en 15 minutes"
            },
            {
                id: 0,
                videoId: "ex3C1-5Dhb8",
                ...
                time: "Il y a 5 jours",
                likes: "28K",
                image: "https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80",
                mainImage: "https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
                description: "Spectacle des aurores boréales en Islande"
            },
            {
                id: 1,
                videoId: "jjqgP9dpD1k",
                ...
                mainImage: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
                description: "L'avenir de la robotique et de l'automatisation"
            },
            {
                id: 2,
                videoId: "Fq2SbrWnfFI",
                ...
                mainImage: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80",
                description: "Les secrets de la pâtisserie française traditionnelle"
            },
            {
                id: 0,
                videoId: "ex3C1-5Dhb8",
                title: "Roadtrip en Norvège",
                category: "Voyage",
                views: "1.8M vues",
                time: "Il y a 1 semaine",
                likes: "33K",
                image: "https://images.unsplash.com/photo-1506929562872-bb421503ef21?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
                mainImage: "https://images.unsplash.com/photo-1506929562872-bb421503ef21?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80",
                description: "Un roadtrip inoubliable à travers les fjords norvégiens"
            }
        ];
