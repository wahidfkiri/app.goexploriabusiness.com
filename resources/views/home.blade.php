...
@section('content')
    ...
    <main class="dashboard-content">
        ...
        <div class="alert alert-warning d-flex align-items-center mt-3" role="alert" style="background: linear-gradient(135deg, #fff8e1, #fff3cd); border: 1px solid #ffc107; border-radius: 12px; padding: 16px 20px;">
